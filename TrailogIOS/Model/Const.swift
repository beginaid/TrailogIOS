...
struct Const {
    ...
    static let firebaseCollectionWeight = "weights"
    static let firebaseCollectionTraining = "trainings"
    static let firebaseCollectionWorkout = "workouts"
    ...
    static let identifierLoginToSignup = "LoginToSignup"
    static let identifierNavigation = "Navigation"
